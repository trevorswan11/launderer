...
if (EXISTS "${ZIG_DIR}/zig" OR EXISTS "${ZIG_DIR}/zig.exe")
    if(WIN32)
        set(ZIG_BIN "${ZIG_DIR}/zig.exe")
    else()
        set(ZIG_BIN "${ZIG_DIR}/zig")
    endif()
    include(${CMAKE_SOURCE_DIR}/cmake/zig-runner.cmake)
elseif(NOT ZIG_FOUND)
    ...
    if("${ZIG_VERSION}" VERSION_LESS "${ZIG_MIN_VERSION}")
        message(WARNING "Zig version too old: ${ZIG_VERSION} < ${ZIG_MIN_VERSION}")
        message(WARNING "Downloading local version of zig")
        include(${CMAKE_SOURCE_DIR}/cmake/zig-download.cmake)
    else()
        set(ZIG_BIN "${ZIG_FOUND}")
    endif()
