...
macro(check_managed_component COMPONENT_NAME VENDOR PACKAGE DEFINE_NAME)
    ...
    elseif("${PACKAGE}" STREQUAL "pcf8574")
        list(APPEND COMP_PATHS "${COMP_BASE}" "${COMP_BASE}")
    elseif("${PACKAGE}" STREQUAL "hd44780")
        list(APPEND COMP_PATHS "${COMP_BASE}" "${COMP_BASE}")
    elseif("${PACKAGE}" STREQUAL "esp_idf_lib_helpers")
        list(APPEND COMP_PATHS "${COMP_BASE}" "${COMP_BASE}")
    elseif("${PACKAGE}" STREQUAL "i2cdev")
        list(APPEND COMP_PATHS "${COMP_BASE}" "${COMP_BASE}")
    else()
...
check_managed_component("PCF8574" "esp-idf-lib" "pcf8574" "HAS_PCF8574")
check_managed_component("HD44780" "esp-idf-lib" "hd44780" "HAS_HD44780")
check_managed_component("I2CDEV" "esp-idf-lib" "i2cdev" "HAS_I2CDEV")
check_managed_component("IDF_LIB_HELPERS" "esp-idf-lib" "esp_idf_lib_helpers" "HAS_IDF_LIB_HELPERS")
